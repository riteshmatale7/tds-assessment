...
@ControllerAdvice
public class CountryRestCallExceptionHandler {

	@ExceptionHandler(value = {CountryRestCallException.class})
	public ResponseEntity<Object> handlerCountryRestCallException(CountryRestCallException e){
